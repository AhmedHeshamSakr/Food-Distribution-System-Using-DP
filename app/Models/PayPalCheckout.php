...
class PaypalCheckout{  
    ...
    public $paypalClientID  = PAYPAL_SANDBOX?PAYPAL_SANDBOX_CLIENT_ID:PAYPAL_SANDBOX_CLIENT_ID;  
    private $paypalSecret   = PAYPAL_SANDBOX?PAYPAL_SANDBOX_CLIENT_SECRET:PAYPAL_SANDBOX_CLIENT_ID;  
