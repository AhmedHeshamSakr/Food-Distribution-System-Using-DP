...
$vehicle = new Vehicle(3505764654546348458458644464644544445544664546565453556456455254524554485654444448576476664, '12345');
$user = new Volunteer(0, 'Jumana', 'Yasser', 'juamna2a65144446456452644445525544524646564435555474446D584245949446654752465955564465679687151a@gmail.com', '01236', $emailLogin, $address, '0158655', $badge);
...
echo "Is Cook: " . ($cook->hasRole(User::COOK_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is DeliveryGuy: " . ($cook->hasRole(User::DELIVERY_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is Coordinator: " . ($cook->hasRole(User::COORDINATOR_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is Reporter: " . ($cook->hasRole(User::REPORTER_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is Donor: " . ($cook->hasRole(User::DONOR_FLAG) ? "Yes" : "No") . "</br>\n";
...
// Test if specific roles are set correctly
echo "Is Cook: " . ($deliveryGuy->hasRole(User::COOK_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is DeliveryGuy: " . ($deliveryGuy->hasRole(User::DELIVERY_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is Coordinator: " . ($deliveryGuy->hasRole(User::COORDINATOR_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is Reporter: " . ($deliveryGuy->hasRole(User::REPORTER_FLAG) ? "Yes" : "No") . "</br>\n";
echo "Is Donor: " . ($deliveryGuy->hasRole(User::DONOR_FLAG) ? "Yes" : "No") . "</br>\n";
